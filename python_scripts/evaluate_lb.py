...
from llamafactory.model.modeling_langbridge import LangBridgeModel
from llamafactory.model.configuration_langbridge import LangBridgeConfig
from llamafactory.hparams import ModelArguments, DataArguments, FinetuningArguments, GeneratingArguments

from lm_eval.models.langbridge import HuggingFaceLB
...
def setup_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        default="",
        type=str,
        help="Comma separated string arguments for encoder tokenizer, e.g. `pretrained=EleutherAI/pythia-160m,dtype=float32`",
    )
    parser.add_argument(
        "--training_hparams",
        default="",
        type=str,
        help="Comma separated string arguments for the path of training hyper parameters yaml file, e.g. `pretrained=EleutherAI/pythia-160m,dtype=float32`",
    )
    parser.add_argument(
        "--checkpoint_path",
        "-p",
        default="",
        type=str,
        help="Comma separated string arguments for the path of checkpoint, e.g. `pretrained=EleutherAI/pythia-160m,dtype=float32`",
    )
    #
    parser.add_argument(
        "--num_fewshot",
